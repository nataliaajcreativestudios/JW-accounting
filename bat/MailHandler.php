...
$mail = "velkast@gmail.com"; 
$asunto = "Information"; 
$mensaje =  "Name: ".$_POST['name']."<br>";
$mensaje .= "Email: ".$_POST['email']."<br>";
$mensaje .= "Phone: ".$_POST['phone']."<br>";
$mensaje .= "Message: ".$_POST['message']."<br>";
...
/*
	...
	$owner_email='mikepractica@gmail.com';
	//SMTP server settings	
	$host = 'www.gmail.com';
    $port = '465';//"587";
    $username = 'mikepractica';
    $password = 'dxextrad';
